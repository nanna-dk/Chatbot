...
module.exports = {
  ...
  /*
     ...
     *
     */
  sendReceiptMessage: function(recipientId, recipient_name, currency, payment_method, timestamp, elements, address, summary, adjustments) {
    let self = module.exports;
  ...
  sendQuickReply: function(recipientId, text, replies, metadata) {
    ...
    var messageData = {
      ...
      message: {
        text: text,
        metadata: self.isDefined(metadata)
          ? metadata
          : '',
